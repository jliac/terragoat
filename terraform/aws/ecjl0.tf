resource "aws_instance" "web_host" {
  # ec2 have plain text secrets in user data by JLLOOOOOOOO1111
  ami           = "${var.ami}"
...
EOF
  tags = {
    ...
    git_commit           = "c73ea3b5f97ad3e88ad24c932f4e8182eed68304"
    git_file             = "terraform/aws/ecjl0.tf"
    git_last_modified_at = "2022-01-07 22:42:02"
