resource "aws_instance" "web_host" {
  # ec2 have plain text secrets in user data by JLLOOOOOOOO1111111111
  ami           = "${var.ami}"
...
EOF
  tags = {
    ...
    git_commit           = "ef5082f9f9bc3f90a8d36ae2d6920e10810f3599"
    git_file             = "terraform/aws/ec2.tf"
    git_last_modified_at = "2021-12-22 00:47:54"
